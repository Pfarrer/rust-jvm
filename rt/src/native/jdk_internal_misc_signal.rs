...
fn find_signal0(vm_thread: &mut VmThread) {
    ...
    warn!("Not properly implemented for signal {} -> will always return 0", get_java_string_value(&*rc_objectref.borrow()));
...
fn handle0(vm_thread: &mut VmThread) {
    ...
    warn!("Not properly implemented for signal {} and nativeH {} -> will always return 0", sig, native_h);
