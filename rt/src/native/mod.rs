...
impl Classloader for NativeClassloader {
    ...
    fn get_native_method(
        ...
        match jvm_class.this_class.as_str() {
            ...
            "java/lang/reflect/Array" => java_lang_reflect_array::get_method(jvm_class, class_method),
            ...
            "java/io/FileInputStream" => java_io_fileinputstream::get_method(jvm_class, class_method),
            "java/io/FileDescriptor" => java_io_filedescriptor::get_method(jvm_class, class_method),
            "java/io/FileOutputStream" => java_io_fileoutputstream::get_method(jvm_class, class_method),
            ...
            "jdk/internal/misc/Signal" => jdk_internal_misc_signal::get_method(jvm_class, class_method),
